...
void GPUResize::image(GPUTexture* source, Img<Eigen::Matrix<unsigned char, 3, 1>>& dest) {
...
void GPUResize::vertex(GPUTexture* source, Img<Eigen::Vector4f>& dest) {
...
void GPUResize::time(GPUTexture* source, Img<unsigned short>& dest) {
